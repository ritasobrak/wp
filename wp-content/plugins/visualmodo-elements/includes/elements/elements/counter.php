...
class WPBakeryShortCode_visualmodo_wpbakery_counter extends WPBakeryShortCode {
	protected function content( $atts, $content = null ) {
		...
		$title_color_default = '';
		if($title_color == '') {
			$title_color_default = $visualmodo_elements_global_color;
		} 
		
		$icon_color_default = '';
		if($icon_color == '') {
			$icon_color_default = $visualmodo_elements_global_color;
		} 		  
		
		
		$output .= '<div '.$el_id.' class="visualmodo-elements-counter text-center '.$css_class.'">';
		
		if($checkicon == 'icon') {
			$output .= '<div class="visualmodo-elements-counter-icon"><i style="font-size:'.$icon_size.'; line-height:'.$icon_line_height.'; color:'.$icon_color.';" class="'.$icon.' '.$icon_color_default.'"></i></div>';
		} 
		
		$output .= '<div class="visualmodo-elements-counter-paramns" style="font-size:'.$counter_size.'; line-height:'.$counter_line_height.'; color:'.$counter_color.';" value="'.$value.'" value-speed="'.$value_speed.'" value-interval="'.$value_interval.'"></div>';
		
		if($title != ''){ 
			$output .= '<'.$title_tag.' style="font-size:'.$title_size.'; line-height:'.$title_line_height.'; color:'.$title_color.';" class="visualmodo-elements-counter-title '.$title_color_default.'">'.$title.'</'.$title_tag.'>'; 
		}
		$output .= '</div>';
...
return array(
	'name' => __( 'Counter', 'visualmodo' ),
	'base' => 'visualmodo_counter',
	'icon' => plugins_url('../images/counter.png', __FILE__),
	'show_settings_on_create' => true,
	'category' => __( 'Visualmodo', 'visualmodo' ),
	'description' => __( 'Your milestones and achievements', 'visualmodo' ),
	'params' => array(
		...
		array(
			'type' => 'textfield',
			'heading' => __( 'Counter Value', 'visualmodo' ),
			'param_name' => 'value',
			'description' => __( 'Enter number for counter without any special character.', 'visualmodo' ),
		),
		
		array(
			'type' => 'textfield',
			'heading' => __( 'Counter Value Speed', 'visualmodo' ),
		...
		array(
			'type' => 'textfield',
			'heading' => __( 'Counter Value Interval', 'visualmodo' ),
		...
		array(
			'type' => 'textfield',
			'heading' => __( 'Counter Size', 'visualmodo' ),
		...
		array(
			'type' => 'textfield',
			'heading' => __( 'Counter Line Height', 'visualmodo' ),
		...
		array(
			'type' => 'colorpicker',
			'heading' => __( 'Counter Color', 'visualmodo' ),
			'param_name' => 'counter_color',
			'description' => __( 'Select custom color for the number.', 'visualmodo' ),
			'group' => 'Typography',
		),
		
		array(
			'type' => 'textfield',
			'heading' => __( 'Icon Size', 'visualmodo' ),
		...
		array(
			'type' => 'textfield',
			'heading' => __( 'Icon Line Height', 'visualmodo' ),
		...
		array(
			...
			'description' => __( 'Select custom color for the icon.', 'visualmodo' ),
			'group' => 'Typography',
			'dependency' => array(
				'element' => 'checkicon',
				'value' => array( 'icon' ),
