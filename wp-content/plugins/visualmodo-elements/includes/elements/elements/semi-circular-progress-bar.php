...
class WPBakeryShortCode_visualmodo_wpbakery_semi_circular_progress_bar extends WPBakeryShortCode {
	protected function content( $atts, $content = null ) {
		...
		if ($style=="icon") { $icon = '<i '.$ip_color.' class="visualmodo-elements-semi-circular-progress-bar-icon '.$icon.'""></i>'; } else { $icon = ""; }
		// End Custom Colors
		
		// Start Output
		
		$output .= '<div '.$el_id.' class="visualmodo-elements-semi-circular-progress-bar '.$css_class.'">';
		$output .= '<div class="visualmodo-elements-semi-circular-progress-bar-inner">';
		$output .= '<div class="visualmodo-elements-semi-circular-progress-bar-params '.$corner.' '.$style.'" '.$height.' percentage="'.$percentage.'" bar_color="'.$bar_color.'" track_color="'.$track_color.'" percentage_color="'.$percentage_color.'" bar_thickness="'.$bar_thickness.'" track_thickness="'.$track_thickness.'"></div>';
		$output .= $icon;
		$output .= '<span '.$title_color.' class="visualmodo-elements-semi-circular-progress-bar-title">'.$title.'</span>';
		$output .= '</div></div>';
...
return array(
	'name' => __( 'Semi Circular Progress Bar', 'visualmodo' ),
	'base' => 'visualmodo_semi_circular_progress_bar',
